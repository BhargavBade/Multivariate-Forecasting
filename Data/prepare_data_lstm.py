...
class DataPreparer:
    ...
    def split_and_standardize_data(self, data):
        ...
        # val_set, test_set = train_test_split(remaining_set, test_size=0.9, shuffle=False, random_state=42)
    ...
    def split_sequences(self, input_sequences, output_sequence, n_steps_in, n_steps_out):
        ...
        for i in range(0, len(input_sequences), n_steps_out):  # Step by n_steps_out  
            ...
            seq_y = output_sequence[end_ix:out_end_ix+1]
            # Extract PM2.5 values for the input sequence (aligned with the output)
            pm25_past_values = output_sequence[i:end_ix+1]  # PM2.5 values in the past window
    ...
    def prepare_data(self):
        ...
        n_steps_in = params_lstm.n_steps_in  # Number of past time steps to use as input
        n_steps_out = params_lstm.n_steps_out # Number of future time steps to predict
        ...
        X_val, y_val, past_pm25_val, val_dt = self.split_sequences(test_data, test_labels, n_steps_in, n_steps_out)
    ...
    def get_tensors(self):
        return (self.train_data_tensor, self.train_labels_tensor, self.past_pm25_train,
