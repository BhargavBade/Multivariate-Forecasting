...
data_ft = params_sparse_data.enc_inp
...
class DataPreparer:
    ...
    def clean_and_process_data(self, data):
        ...
        data = data.drop(columns= params_sparse_data.drop_feat)
    ...
    def introduce_nans(self, data, nan_fraction=params_sparse_data.nan_fraction):
        """
    ...
    def scale_data (self, time_series_data):
        ...
        feature_cols = slice(4, params_sparse_data.data_feat)  # Selecting columns 4 to 14 (features only)
    ...
    def prepare_informer_data(self, input_sequences, seq_len, label_len, pred_len):
        ...
        feature_cols = slice(4, params_sparse_data.data_feat)
    ...
    def prepare_data(self):
        ...
        encoder_months = params_sparse_data.encoder_months
        decoder_months = params_sparse_data.decoder_months
        pred_months = params_sparse_data.pred_months
